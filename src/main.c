...
static const SummaryPoint gSummaryMap050ToScoringFType[T050_H][T050_W] = {
    /* y = 0 */
    {
     ...
     { 38,   0}, { 40,   0}, { 41,   0}, {255, 255}, {255, 255}, {255, 255},
     {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255},
     {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255},
    ...
    /* y = 1 */
    {
     ...
     {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255},
     {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255},
     { 28,   2}, { 30,   2}, { 31,   2}, { 33,   2}, { 34,   2}, { 36,   2},
     { 37,   2}, { 40,   2}, { 40,   2}, { 43,   2}, { 43,   2}, {255, 255},
     {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255},
     {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255},
     {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255}
    },
    ...
    /* y = 2 */
    {
     {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255},
     {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255},
     {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255}, { 27,   3},
     { 28,   3}, { 30,   3}, { 31,   3}, { 33,   3}, { 34,   3}, { 36,   3},
     { 37,   3}, { 40,   3}, { 40,   3}, { 43,   3}, { 43,   3}, { 46,   3},
     {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255},
     {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255},
     {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255}
    },
    ...
    /* y = 3 */
    {
     {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255},
     {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255},
     {255, 255}, {255, 255}, {255, 255}, {255, 255}, { 25,   5}, { 27,   5},
     { 28,   5}, { 30,   5}, { 31,   5}, { 33,   5}, { 34,   5}, { 36,   5},
     { 37,   5}, { 40,   5}, { 40,   5}, { 43,   5}, { 43,   5}, { 46,   5},
     { 48,   5}, {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255},
     {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255},
     {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255}
    },
    ...
    /* y = 4 */
    {
     {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255},
     {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255},
     {255, 255}, {255, 255}, {255, 255}, { 24,   6}, { 25,   6}, { 27,   6},
     { 28,   6}, { 30,   6}, { 31,   6}, { 33,   6}, { 34,   6}, { 36,   6},
     { 37,   6}, { 40,   6}, { 40,   6}, { 43,   6}, { 43,   6}, { 46,   6},
     { 48,   6}, { 49,   6}, {255, 255}, {255, 255}, {255, 255}, {255, 255},
     {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255},
     {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255}
    },
    ...
    /* y = 5 */
    {
     {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255},
     {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255},
     {255, 255}, {255, 255}, {255, 255}, { 23,   8}, { 25,   8}, { 26,   8},
     { 29,   8}, { 29,   8}, { 31,   8}, { 33,   8}, { 34,   8}, { 36,   8},
     { 37,   8}, { 40,   8}, { 40,   8}, { 42,   8}, { 44,   8}, { 45,   8},
     { 48,   8}, { 48,   8}, {255, 255}, {255, 255}, {255, 255}, {255, 255},
     {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255},
     {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255}
    },
    ...
    /* y = 6 */
    {
     {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255},
     {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255},
     {255, 255}, {255, 255}, { 22,  10}, { 24,  10}, { 25,  10}, { 27,  10},
     { 28,  10}, { 30,  10}, { 31,  10}, { 33,  10}, { 35,  10}, { 36,  10},
     { 38,  10}, { 40,  10}, { 40,  10}, { 43,  10}, { 43,  10}, { 46,  10},
     { 48,  10}, { 49,  10}, { 51,  10}, {255, 255}, {255, 255}, {255, 255},
     {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255},
     {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255}
    },
    ...
    /* y = 7 */
    {
     {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255},
     {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255},
     {255, 255}, {255, 255}, { 22,  11}, { 24,  11}, { 25,  11}, { 27,  11},
     { 28,  11}, { 30,  11}, { 31,  11}, { 33,  11}, { 34,  11}, { 36,  11},
     { 37,  11}, { 40,  11}, { 40,  11}, { 43,  11}, { 43,  11}, { 46,  11},
     { 48,  11}, { 49,  11}, { 51,  11}, {255, 255}, {255, 255}, {255, 255},
     {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255},
     {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255}
    },
    ...
    /* y = 8 */
    {
     {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255},
     {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255},
     {255, 255}, {255, 255}, { 21,  13}, { 24,  13}, { 24,  13}, { 26,  13},
     { 29,  13}, { 29,  13}, { 32,  13}, { 32,  13}, { 34,  13}, { 36,  13},
     { 37,  13}, { 39,  13}, { 41,  13}, { 42,  13}, { 44,  13}, { 45,  13},
     { 47,  13}, { 49,  13}, { 50,  13}, {255, 255}, {255, 255}, {255, 255},
     {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255},
     {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255}
    },
    ...
    /* y = 9 */
    {
     {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255},
     {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255},
     {255, 255}, { 21,  14}, { 22,  14}, { 24,  14}, { 25,  14}, { 27,  14},
     { 29,  14}, { 30,  14}, { 32,  14}, { 33,  14}, { 35,  14}, { 36,  14},
     { 38,  14}, { 40,  14}, { 41,  14}, { 43,  14}, { 44,  14}, { 46,  14},
     { 48,  14}, { 49,  14}, { 51,  14}, { 52,  14}, {255, 255}, {255, 255},
     {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255},
     {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255}
    },
    ...
    /* y = 10 */
    {
     {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255},
     {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255},
     {255, 255}, { 20,  16}, { 22,  16}, { 23,  16}, { 25,  16}, { 26,  16},
     { 29,  16}, { 29,  16}, { 31,  16}, { 33,  16}, { 34,  16}, { 36,  16},
     { 37,  16}, { 40,  16}, { 40,  16}, { 42,  16}, { 44,  16}, { 45,  16},
     { 48,  16}, { 48,  16}, { 51,  16}, { 51,  16}, {255, 255}, {255, 255},
     {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255},
     {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255}
    },
    ...
    /* y = 11 */
    {
     {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255},
     {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255},
     { 18,  18}, { 21,  18}, { 21,  18}, { 24,  18}, { 24,  18}, { 27,  18},
     { 29,  18}, { 29,  18}, { 32,  18}, { 32,  18}, { 35,  18}, { 36,  18},
     { 38,  18}, { 39,  18}, { 41,  18}, { 42,  18}, { 44,  18}, { 46,  18},
     { 47,  18}, { 49,  18}, { 50,  18}, { 52,  18}, { 53,  18}, {255, 255},
     {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255},
     {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255}
    },
    ...
    {
     {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255},
     {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255}, { 18,  19},
     { 18,  19}, { 21,  19}, { 21,  19}, { 24,  19}, { 24,  19}, { 27,  19},
     { 29,  19}, { 30,  19}, { 32,  19}, { 33,  19}, { 35,  19}, { 36,  19},
     { 38,  19}, { 39,  19}, { 41,  19}, { 42,  19}, { 44,  19}, { 45,  19},
     { 48,  19}, { 48,  19}, { 51,  19}, { 51,  19}, { 54,  19}, { 56,  19},
     {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255},
     {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255}
    },
    ...
    {
     {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255},
     {255, 255}, {255, 255}, {255, 255}, {255, 255}, { 16,  21}, { 16,  21},
     { 19,  21}, { 21,  21}, { 22,  21}, { 24,  21}, { 25,  21}, { 27,  21},
     { 28,  21}, { 30,  21}, { 32,  21}, { 33,  21}, { 35,  21}, { 36,  21},
     { 38,  21}, { 40,  21}, { 41,  21}, { 43,  21}, { 43,  21}, { 46,  21},
     { 48,  21}, { 49,  21}, { 51,  21}, { 52,  21}, { 54,  21}, { 55,  21},
     { 57,  21}, {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255},
     {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255}
    },
    ...
    {
     {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255},
     {255, 255}, {255, 255}, { 15,  22}, { 15,  22}, { 16,  22}, { 16,  22},
     { 19,  22}, { 21,  22}, { 22,  22}, { 24,  22}, { 25,  22}, { 27,  22},
     { 28,  22}, { 30,  22}, { 31,  22}, { 33,  22}, { 34,  22}, { 36,  22},
     { 38,  22}, { 40,  22}, { 41,  22}, { 43,  22}, { 44,  22}, { 46,  22},
     { 47,  22}, { 49,  22}, { 50,  22}, { 52,  22}, { 53,  22}, { 56,  22},
     { 56,  22}, { 59,  22}, {255, 255}, {255, 255}, {255, 255}, {255, 255},
     {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255}
    },
    ...
    {
     {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255},
     { 10,  25}, { 12,  24}, { 12,  24}, { 14,  24}, { 15,  24}, { 17,  24},
     { 18,  24}, { 21,  24}, { 21,  24}, { 24,  24}, { 25,  24}, { 27,  24},
     { 29,  24}, { 30,  24}, { 32,  24}, { 33,  24}, { 35,  24}, { 36,  24},
     { 38,  24}, { 39,  24}, { 41,  24}, { 42,  24}, { 44,  24}, { 46,  24},
     { 48,  24}, { 49,  24}, { 51,  24}, { 51,  24}, { 54,  24}, { 56,  24},
     { 57,  24}, { 59,  24}, { 60,  24}, {255, 255}, {255, 255}, {255, 255},
     {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255}
    },

    /* y = 16 */
    {
     {255, 255}, {255, 255}, {255, 255}, {255, 255}, {  6,  27}, { 10,  25},
     { 10,  25}, { 11,  25}, { 13,  25}, { 14,  25}, { 16,  25}, { 17,  25},
     { 19,  25}, { 20,  25}, { 22,  25}, { 23,  25}, { 25,  25}, { 26,  25},
     { 29,  25}, { 30,  25}, { 32,  25}, { 33,  25}, { 35,  25}, { 36,  25},
     { 38,  25}, { 39,  25}, { 41,  25}, { 42,  25}, { 44,  25}, { 46,  25},
     { 48,  25}, { 49,  25}, { 51,  25}, { 52,  25}, { 54,  25}, { 55,  25},
     { 57,  25}, { 58,  25}, { 60,  25}, { 61,  25}, { 63,  25}, {255, 255},
     {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255}
    },

    /* y = 17 */
    {
     {255, 255}, {255, 255}, {  4,  28}, {  6,  27}, {  6,  27}, {  8,  27},
     {  9,  27}, { 11,  27}, { 12,  27}, { 14,  27}, { 15,  27}, { 17,  27},
     { 18,  27}, { 21,  27}, { 21,  27}, { 24,  27}, { 24,  27}, { 27,  27},
     { 29,  27}, { 30,  27}, { 32,  27}, { 33,  27}, { 35,  27}, { 36,  27},
     { 38,  27}, { 39,  27}, { 41,  27}, { 42,  27}, { 44,  27}, { 45,  27},
     { 48,  27}, { 48,  27}, { 51,  27}, { 51,  27}, { 54,  27}, { 56,  27},
     { 57,  27}, { 59,  27}, { 60,  27}, { 62,  27}, { 63,  27}, { 65,  27},
     { 66,  27}, {255, 255}, {255, 255}, {255, 255}, {255, 255}
    },

    /* y = 18 */
    {
     {255, 255}, {  3,  29}, {  3,  29}, {  5,  29}, {  6,  29}, {  8,  29},
     {  9,  29}, { 11,  29}, { 12,  29}, { 14,  29}, { 15,  29}, { 17,  29},
     { 18,  29}, { 20,  29}, { 22,  29}, { 23,  29}, { 25,  29}, { 26,  29},
     { 29,  29}, { 29,  29}, { 32,  29}, { 32,  29}, { 35,  29}, { 35,  29},
     { 37,  29}, { 40,  29}, { 40,  29}, { 43,  29}, { 43,  29}, { 46,  29},
     { 48,  29}, { 49,  29}, { 51,  29}, { 52,  29}, { 54,  29}, { 56,  29},
     { 57,  29}, { 59,  29}, { 60,  29}, { 62,  29}, { 63,  29}, { 65,  29},
     { 66,  29}, { 68,  29}, { 69,  29}, {255, 255}, {255, 255}
    },

    /* y = 19 */
    {
     {  2,  30}, {  2,  30}, {  2,  30}, {  5,  30}, {  6,  30}, {  8,  30},
     { 10,  30}, { 11,  30}, { 12,  30}, { 14,  30}, { 16,  30}, { 17,  30},
     { 18,  30}, { 20,  30}, { 22,  30}, { 24,  30}, { 24,  30}, { 26,  30},
     { 29,  30}, { 30,  30}, { 32,  30}, { 32,  30}, { 35,  30}, { 36,  30},
     { 38,  30}, { 40,  30}, { 41,  30}, { 42,  30}, { 44,  30}, { 46,  30},
     { 48,  30}, { 48,  30}, { 50,  30}, { 52,  30}, { 54,  30}, { 56,  30},
     { 56,  30}, { 59,  30}, { 60,  30}, { 62,  30}, { 62,  30}, { 65,  30},
     { 66,  30}, { 68,  30}, { 70,  30}, { 71,  30}, {255, 255}
    },

    /* y = 20 */
    {
     {  1,  32}, {  1,  32}, {  3,  32}, {  4,  32}, {  6,  32}, {  7,  32},
     { 10,  32}, { 10,  32}, { 13,  32}, { 13,  32}, { 16,  32}, { 16,  32},
     { 19,  32}, { 21,  32}, { 22,  32}, { 24,  32}, { 25,  32}, { 27,  32},
     { 29,  32}, { 30,  32}, { 32,  32}, { 33,  32}, { 35,  32}, { 36,  32},
     { 38,  32}, { 40,  32}, { 41,  32}, { 43,  32}, { 44,  32}, { 46,  32},
     { 48,  32}, { 49,  32}, { 51,  32}, { 52,  32}, { 54,  32}, { 55,  32},
     { 57,  32}, { 58,  32}, { 60,  32}, { 61,  32}, { 63,  32}, { 64,  32},
     { 67,  32}, { 67,  32}, { 70,  32}, { 70,  32}, { 72,  32}
    },

    /* y = 21 */
    {
     {  0,  33}, {  2,  33}, {  3,  33}, {  5,  33}, {  6,  33}, {  8,  33},
     {  9,  33}, { 11,  33}, { 12,  33}, { 14,  33}, { 16,  33}, { 17,  33},
     { 19,  33}, { 20,  33}, { 22,  33}, { 23,  33}, { 25,  33}, { 26,  33},
     { 28,  33}, { 30,  33}, { 31,  33}, { 33,  33}, { 34,  33}, { 36,  33},
     { 37,  33}, { 40,  33}, { 40,  33}, { 43,  33}, { 43,  33}, { 45,  33},
     { 48,  33}, { 48,  33}, { 51,  33}, { 51,  33}, { 54,  33}, { 56,  33},
     { 57,  33}, { 59,  33}, { 59,  33}, { 62,  33}, { 62,  33}, { 65,  33},
     { 67,  33}, { 68,  33}, { 70,  33}, { 71,  33}, { 73,  33}
    },

    /* y = 22 */
    {
     {  0,  35}, {  2,  35}, {  3,  35}, {  5,  35}, {  6,  35}, {  8,  35},
     { 10,  35}, { 11,  35}, { 13,  35}, { 14,  35}, { 16,  35}, { 17,  35},
     { 19,  35}, { 20,  35}, { 22,  35}, { 23,  35}, { 25,  35}, { 26,  35},
     { 29,  35}, { 30,  35}, { 32,  35}, { 33,  35}, { 35,  35}, { 36,  35},
     { 38,  35}, { 40,  35}, { 41,  35}, { 43,  35}, { 44,  35}, { 45,  35},
     { 48,  35}, { 48,  35}, { 51,  35}, { 51,  35}, { 54,  35}, { 56,  35},
     { 57,  35}, { 59,  35}, { 60,  35}, { 62,  35}, { 63,  35}, { 65,  35},
     { 67,  35}, { 68,  35}, { 70,  35}, { 71,  35}, { 73,  35}
    }
};
...
static const SummaryPoint gSummaryMap100ToScoringFType[T100_H][T100_W] = {
    ...
    {
     {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255},
     {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255}, { 32,   0},
     { 33,   0}, { 36,   0}, { 38,   0}, { 41,   0}, {255, 255}, {255, 255},
     {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255},
    ...
    {
     {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255},
     {255, 255}, {255, 255}, {255, 255}, {255, 255}, { 28,   3}, { 31,   3},
     { 34,   3}, { 36,   3}, { 39,   3}, { 42,   3}, { 45,   3}, {255, 255},
     {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255},
     {255, 255}, {255, 255}, {255, 255}
    },
    ...
    {
     {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255},
     {255, 255}, {255, 255}, { 23,   7}, { 25,   6}, { 28,   6}, { 31,   6},
     { 34,   6}, { 36,   6}, { 39,   6}, { 42,   6}, { 45,   6}, { 48,   6},
     { 50,   7}, {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255},
     {255, 255}, {255, 255}, {255, 255}
    },
    ...
    {
     {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255},
     {255, 255}, {255, 255}, { 22,  10}, { 25,   8}, { 28,   8}, { 31,   8},
     { 34,   8}, { 36,   8}, { 39,   8}, { 42,   8}, { 45,   8}, { 48,   8},
     { 51,  10}, {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255},
     {255, 255}, {255, 255}, {255, 255}
    },
    ...
    {
     {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255},
     {255, 255}, {255, 255}, { 22,  11}, { 25,  11}, { 28,  11}, { 31,  11},
     { 34,  11}, { 36,  11}, { 39,  11}, { 42,  11}, { 45,  11}, { 48,  11},
     { 51,  11}, {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255},
     {255, 255}, {255, 255}, {255, 255}
    },
    ...
    {
     {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255},
     {255, 255}, { 20,  16}, { 22,  14}, { 25,  14}, { 28,  14}, { 31,  14},
     { 34,  14}, { 36,  14}, { 39,  14}, { 42,  14}, { 45,  14}, { 48,  14},
     { 51,  14}, { 53,  16}, {255, 255}, {255, 255}, {255, 255}, {255, 255},
     {255, 255}, {255, 255}, {255, 255}
    },
    ...
    {
     {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255},
     {255, 255}, { 20,  18}, { 21,  18}, { 24,  18}, { 28,  18}, { 31,  18},
     { 34,  18}, { 36,  18}, { 39,  18}, { 42,  18}, { 45,  18}, { 47,  18},
     { 50,  18}, { 53,  18}, {255, 255}, {255, 255}, {255, 255}, {255, 255},
     {255, 255}, {255, 255}, {255, 255}
    },
    ...
    {
     {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255}, {255, 255},
     { 18,  19}, { 20,  19}, { 22,  21}, { 25,  21}, { 28,  21}, { 31,  21},
     { 34,  21}, { 36,  19}, { 39,  19}, { 42,  19}, { 45,  19}, { 48,  19},
     { 51,  19}, { 53,  19}, { 56,  19}, {255, 255}, {255, 255}, {255, 255},
     {255, 255}, {255, 255}, {255, 255}
    },

    /* y = 8 */
    {
     {255, 255}, {255, 255}, {255, 255}, {255, 255}, { 12,  24}, { 14,  24},
     { 17,  24}, { 20,  24}, { 22,  22}, { 25,  22}, { 28,  22}, { 31,  22},
     { 34,  22}, { 36,  22}, { 39,  24}, { 42,  24}, { 45,  24}, { 48,  24},
     { 51,  24}, { 53,  22}, { 56,  22}, { 59,  22}, { 62,  24}, {255, 255},
     {255, 255}, {255, 255}, {255, 255}
    },

    /* y = 9 */
    {
     {255, 255}, {255, 255}, {255, 255}, {  8,  27}, { 11,  25}, { 14,  25},
     { 17,  25}, { 20,  25}, { 22,  25}, { 25,  25}, { 28,  25}, { 30,  25},
     { 33,  25}, { 36,  25}, { 39,  25}, { 42,  25}, { 45,  25}, { 48,  25},
     { 51,  25}, { 53,  27}, { 56,  27}, { 59,  27}, { 62,  27}, { 65,  27},
     {255, 255}, {255, 255}, {255, 255}
    },

    /* y = 10 */
    {
     {255, 255}, {  3,  29}, {  6,  29}, {  8,  29}, { 11,  29}, { 14,  29},
     { 17,  29}, { 20,  29}, { 22,  29}, { 25,  29}, { 28,  29}, { 31,  29},
     { 34,  29}, { 35,  29}, { 39,  29}, { 42,  29}, { 45,  29}, { 48,  29},
     { 51,  29}, { 52,  29}, { 56,  29}, { 59,  29}, { 62,  29}, { 65,  29},
     { 66,  29}, { 69,  29}, {255, 255}
    },

    /* y = 11 */
    {
     {  1,  32}, {  3,  32}, {  6,  32}, {  7,  32}, { 10,  32}, { 13,  32},
     { 16,  32}, { 20,  32}, { 22,  32}, { 25,  32}, { 28,  32}, { 31,  32},
     { 34,  32}, { 36,  32}, { 39,  32}, { 42,  32}, { 45,  32}, { 48,  32},
     { 51,  32}, { 53,  32}, { 55,  32}, { 58,  32}, { 61,  32}, { 64,  32},
     { 67,  32}, { 70,  32}, { 72,  32}
    },

    /* y = 12 */
    {
     {  0,  35}, {  3,  35}, {  6,  35}, {  8,  35}, { 11,  35}, { 14,  35},
     { 17,  35}, { 20,  35}, { 22,  35}, { 25,  35}, { 28,  35}, { 31,  35},
     { 34,  35}, { 36,  35}, { 39,  35}, { 42,  35}, { 45,  35}, { 48,  35},
     { 51,  35}, { 53,  35}, { 56,  35}, { 59,  35}, { 62,  35}, { 65,  35},
     { 67,  35}, { 70,  35}, { 73,  35}
    }
};
...
static const SummaryPoint gSummaryMap150ToScoringEType[T150_H][T150_W] = {
    /* y = 0 */
    {{255, 255}, {255, 255}, {255, 255}, {15, 0}, {18, 0}, {22, 0}, {255, 255}, {255, 255}, {255, 255}},
    /* y = 1 */
    {{255, 255}, {255, 255}, {10, 4}, {14, 4}, {18, 4}, {23, 4}, {27, 4}, {255, 255}, {255, 255}},
    /* y = 2 */
    {{255, 255}, {255, 255}, {10, 7}, {14, 7}, {18, 7}, {23, 7}, {27, 7}, {255, 255}, {255, 255}},
    /* y = 3 */
    {{255, 255}, {255, 255}, {10, 11}, {14, 11}, {18, 11}, {23, 11}, {27, 11}, {255, 255}, {255, 255}},
    /* y = 4 */
...
static const SummaryPoint gSummaryMap200ToScoringEType[T200_H][T200_W] = {
    ...
    /* y = 1 */
    {{255, 255}, {10, 5}, {12, 5}, {18, 5}, {25, 5}, {27, 5}, {255, 255}},
    /* y = 2 */
